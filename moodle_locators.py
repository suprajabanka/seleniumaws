...
# ----------------------- locators section ------------------------------
app = 'Moodle'
admin_username = 'venkatabanka'
admin_password = 'Sainatha@786'
...
web_page = fake.url()
icq_num = fake.pyint(11111, 99999)
skype_id = new_username
aim_id = f'{last_name.lower()}{fake.pyint(111, 9999)}'
yahoo_id = new_username
msn_id = f'{last_name.lower()}{fake.pyint(111, 9999)}{country}'
id_num = fake.pyint(111111, 999999)
...
list_id = ['id_url', 'id_icq', 'id_skype', 'id_aim', 'id_yahoo', 'id_msn', 'id_idnumber', 'id_institution',
            'id_department', 'id_phone1', 'id_phone2', 'id_address']

list_val = [web_page, icq_num, skype_id, aim_id, yahoo_id, msn_id,
            id_num, institution, department, phone, mobile_phone, address]
